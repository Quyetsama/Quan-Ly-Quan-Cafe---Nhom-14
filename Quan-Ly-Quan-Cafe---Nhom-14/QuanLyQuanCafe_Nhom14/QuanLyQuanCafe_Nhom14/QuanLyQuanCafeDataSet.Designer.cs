...
namespace QuanLyQuanCafe_Nhom14 {
    ...
    public partial class QuanLyQuanCafeDataSet : global::System.Data.DataSet {
        ...
        public partial class FoodDataTable : global::System.Data.TypedTableBase<FoodRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FoodRow AddFoodRow(string name, int idCategory, double price, int discount) {
        ...
        public partial class FoodRow : global::System.Data.DataRow {
            ...
            public int discount {
                get {
                    try {
                        return ((int)(this[this.tableFood.discountColumn]));
                    }
...
namespace QuanLyQuanCafe_Nhom14.QuanLyQuanCafeDataSetTableAdapters {
    ...
    public partial class FoodTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Food] WHERE (([id] = @Original_id) AND ([name] = @Original_nam" +
                "e) AND ([idCategory] = @Original_idCategory) AND ([price] = @Original_price) AND" +
                " ((@IsNull_discount = 1 AND [discount] IS NULL) OR ([discount] = @Original_disco" +
                "unt)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Food] ([name], [idCategory], [price], [discount]) VALUES (@nam" +
                "e, @idCategory, @price, @discount);\r\nSELECT id, name, idCategory, price, discoun" +
                "t FROM Food WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Food] SET [name] = @name, [idCategory] = @idCategory, [price] = @price, [discount] = @discount WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([idCategory] = @Original_idCategory) AND ([price] = @Original_price) AND ((@IsNull_discount = 1 AND [discount] IS NULL) OR ([discount] = @Original_discount)));
SELECT id, name, idCategory, price, discount FROM Food WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLyQuanCafe_Nhom14.Properties.Settings.Default.QuanLyQuanCafeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, idCategory, price, discount FROM dbo.Food";
        ...
        public virtual int Delete(int Original_id, string Original_name, int Original_idCategory, double Original_price, global::System.Nullable<int> Original_discount) {
        ...
        public virtual int Insert(string name, int idCategory, double price, global::System.Nullable<int> discount) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, int idCategory, double price, global::System.Nullable<int> discount, int Original_id, string Original_name, int Original_idCategory, double Original_price, global::System.Nullable<int> Original_discount, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, int idCategory, double price, global::System.Nullable<int> discount, int Original_id, string Original_name, int Original_idCategory, double Original_price, global::System.Nullable<int> Original_discount) {
            return this.Update(name, idCategory, price, discount, Original_id, Original_name, Original_idCategory, Original_price, Original_discount, Original_id);
        }
    }
